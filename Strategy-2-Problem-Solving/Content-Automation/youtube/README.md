...
Automated faceless video pipeline: English–Yoruba language blending, trending topics, scripts, research, subtitles, and performance tracking.
...
```powershell
python main.py launch --dry-run   # Plan 12 launch videos
