...
4. **Optional auto-paste** — Asks “Auto-paste in 3 sec?”; if yes, after you focus Cursor chat it sends Ctrl+V so you don’t have to paste manually.
...
| `paste_after_delay(seconds: float = 3.0) -> None` | After a delay, send Ctrl+V to the focused window (requires `pyautogui`). |
